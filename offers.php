        ...
        <div class="container page">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <?php
                    ...
                    if (count($sentDeclinedOffersSellItems) > 0) {
            
                        echo "<h3>Declined Offers</h3>";
                
                        for ($i = 0; $i < count($sentDeclinedOffersSellItems); $i++) {
                            ...
                            echo "<div class='row'>";
                                ...
                                echo "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'>";
                                    echo "<div class='offer-item-image centerBlock'>";
                                        $coverImage = "images/" . $sentDeclinedOffersSellItems[$i]["coverImage"];
                                        echo "<img src='$coverImage' class='img-responsive'>";
                                    echo "</div>";
                                echo "</div>";
                                ...
                                echo "<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>";
                                    ...
                                    echo "<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>";
                                        ...
                                        echo "<div class='col-xs-12 col-sm-12 col-md-8 col-lg-8'>";
                                            echo "<h3>" . $sentDeclinedOffersSellItems[$i]['title'] . "</h3>";
                                        echo "</div>";
                                        echo "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'>";
                                            echo "<h3>$" . $sentDeclinedOffersSellItems[$i]['price'] . "</h3>";
                                        echo "</div>";
                                    ...
                                    echo "<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>";
                                        ...
                                        if ($sentDeclinedOffers[$i]["tradeProductId"] != 0) {
                                            
                                            echo "<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>";
                                                echo "<h4 style='color: grey'>plus trade item " . $sentDeclinedOffers[$i]["date"] . "</h4>";
                                            echo "</div>";
                                            ...
                                            echo "<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>";
                                                echo "<h4 style='color: grey'>" . $sentDeclinedOffers[$i]["date"] . "</h4>";
                                            echo "</div>";
                                    ...
                                    echo "<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>";
                                        ...
                                        echo "<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>";
                                            echo "<a class=\"btn btn-default\" style=\"width: 100%;\" href=\"product-detail.php?id=".$sentDeclinedOffersSellItems[$i]['id']."\";>View Item</a>";
                                        echo "</div>";
                                        echo "<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>";
                                            echo "<a class=\"btn btn-default\" style=\"width: 100%;\" href=\"offer-detail.php?id=".$sentDeclinedOffers[$i]['id']."\";>View Offer</a>";
                                        echo "</div>";
                        ...
                        echo "<h3 style='color: grey'>you have no sent offers that were declined</h3>";
                    }
